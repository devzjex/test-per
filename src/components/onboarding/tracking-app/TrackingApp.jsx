...
export default function TrackingApp({ type, backToMain }) {
    ...
    const handleAction = (isBack) => {
        const stepMap = {
            ...
            'track-app-search-step-2': () =>
                setCurrentStep(isBack ? 'track-app-search-step-1' : 'track-app-search-step-3'),
            'track-app-search-step-3': () =>
                setCurrentStep(isBack ? 'track-app-search-step-2' : 'track-app-search-step-4'),
