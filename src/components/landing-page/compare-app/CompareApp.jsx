    ...
    const items = [
        {
            ...
            key: '1',
            children: (
                <RankingApp compareAppData={compareAppData || []} initialDataTopKeyWord={initialDataTopKeyWord} />
            ),
        },
        ...
        { label: 'Review', key: '4', children: <ReviewApp compareAppData={compareAppData || []} /> },
        {
            ...
            key: '5',
            children: <PopularComparisons compareAppData={compareAppData || []} />,
        },
    ];
        ...
        <>
            ...
            <div className="container-compare_apps container" id="compare">
                <div className="compare-header">
                    <div className="top">
                        <div
                            className={`${showWarning ? 'isAlert' : 'search-app_compare'} ${isWidth60 ? 'width-60' : ''}`}
                        >
                            ...
                            <div className="show-alert">
                                {showWarning && (
                                    <Alert message="Please enter 2 or more apps to compare" type="warning" />
                                )}
                            </div>
                        </div>
                    </div>
