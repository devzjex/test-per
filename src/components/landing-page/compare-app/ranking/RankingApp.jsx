                                    ...
                                    <li key={index} className="item">
                                        <div className="positions">
                                            ...
                                            <div className="total-rank">
                                                <span>
                                                    {category.total_apps === '...' ? null : category.total_apps}
                                                </span>
                                            </div>
                                            <div className="icon">
                                                {category.rank === '...' ? null : category.before_rank - category.rank <
                                                  0 ? (
                                                    <div className="rank-down rank">
                                                        <DownOutlined />
                                                        <div className="down">
                                                            <span>
                                                                {Math.abs(category.before_rank - category.rank)}
                                                            </span>
                                                        </div>
                                                    </div>
                            ...
                            <ul key={index}>
                                <li className="text-nowarp">
                                    <Tooltip title={collection.collection_name}>
                                        <MyLink
                                            href={`${BASE_URL}collection/${collection.collection_id}`}
                                            target="__blank"
                                        >
                            ...
                            categoriesToShow.map((collection, index) => (
                                <li key={index} className="item">
                                    <div className="positions">
                                        ...
                                        <div className="total-rank">
                                            <span>
                                                {collection.total_apps === '...' ? null : collection.total_apps}
                                            </span>
                                        </div>
                                        <div className="icon">
                                            {collection.rank === '...' ? null : collection.before_rank -
                                                  collection.rank <
                                              0 ? (
                                                <div className="rank-down rank">
                                                    <DownOutlined />
                                                    <div className="down">
                                                        <span>
                                                            {Math.abs(collection.before_rank - collection.rank)}
                                                        </span>
                                                    </div>
                                                </div>
                        ...
                        <div className="app">
                            ...
                            <div className="title-app">
                                ...
                                <div className="rating">
                                    ...
                                    <span>&nbsp;|&nbsp;</span>
                                    <MyLink
                                        href={`${BASE_URL}app/${item.detail.app_id}/reviews`}
