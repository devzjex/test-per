        ...
        <div className="layoutLandingPage">
            <div className="layoutLandingPageIntro">
                ...
                <div className="container">
                    <Row type="flex" className="content-banner" justify={'space-between'}>
                        <Col lg={12} span={24}>
                            ...
                            {data?.count && (
                                <Row justify={'space-between'}>
                                    {[
                                        ...
                                        <MyLink key={index} href={item.href} className="detailLink">
                                            <Col className="detailBox">
                                                <Row>
                                                    <Typography.Text className="totalTitle" level={1}>
                                                        <Counter end={item?.value ?? 0} duration={3000} />
                                                    </Typography.Text>
                                                </Row>
                                                <Row>
                                                    <Typography.Text className="totalDesc">
                                                        {item.title}
                                                    </Typography.Text>
                                                </Row>
                                            </Col>
                        ...
                        <FadeInSection>
                            ...
                            <Row className="text-merket_content">
                                <Typography.Text className="dashboardExploreText">
                                    Let’s Metrix helps marketers, developers and product managers to understand insights
                                    and data across thousands Shopify Apps
                                </Typography.Text>
                            </Row>
                            {data?.count && (
                                <Row justify={'space-between'}>
                                    {[
                                        {
                                            ...
                                            value: 'Access unlimited keyword analytics powered by AI and user insights to boost app visibility and optimize user experience',
                                        },
                                        {
                                            image: '/image/revenue.png',
                                            title: 'Revenue & Growth Tracking',
                                            value: 'Monitor revenue, retention rate, churn rate and subscriptions to optimize financial performance and business strategies.',
                                        },
                                        {
                                            image: '/image/changelog.png',
                                            title: 'Competitor Changelog Analysis',
                                            value: 'Track competitor changes, rankings, and reviews to gain insights and stay ahead in the market.',
                                        },
                                        {
                                            image: '/image/comparison.png',
                                            title: 'App Comparison',
                                            value: 'Compare unlimited apps, diverse filters, category rankings, reviews, and ranking changes over time. ',
                                        },
                                    ].map((item, index) => (
