    ...
    return [
      {
        ...
        render: (item) => (
          <Row align={'middle'} gutter={20}>
            ...
            <Col span={12}>
              <Typography.Title level={3} className="appName" ellipsis={{ rows: 2, tooltip: item.name }}>
      ...
      },
      {
        ...
        dataIndex: 'app',
        render: (item) => <div className="appDesc">{item?.desc}</div>,
      },
      {
        title: (
          <Typography.Title level={3} style={{ margin: 0, fontSize: '16px' }}>
