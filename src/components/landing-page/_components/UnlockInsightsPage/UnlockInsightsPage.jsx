                        ...
                        <FadeInSection>
                            ...
                            <Row className="textMarket">
                                <Typography.Text className="dashboardExploreText">
                                    Easily access and analyze key data through our intuitive, user-friendly dashboard
                                    for better decision-making and optimized performance.
                                </Typography.Text>
                            </Row>
                            {data?.count && (
                                <Row justify={'space-between'}>
                                    {[
                                        ...
                                        },
                                        {
                                            ...
                                            value: 'Conduct competitor research with Letsmetrix’s user-friendly and detailed app comparison tables',
                                            cotent: [
                                                'App info',
                                                'Ranking',
                                                'Review',
