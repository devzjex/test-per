            ...
            keywordPosition.map((item, index) => {
                if (!item.show) {
                    data.push({
                        ...
                        uniquePageviews:
                            item.ga_keyword &&
                            (item.ga_keyword.uniquePageviews || item.ga_keyword.uniquePageviews === 0)
                        ...
                        conversion_rate:
                            item.ga_keyword && item.ga_keyword.uniquePageviews
                                ? parseFloat(
                                      (item.ga_keyword.uniqueEvents * 100) / item.ga_keyword.uniquePageviews,
                                  ).toFixed(2)
                                : ' ',
                        avgTimeOnPage:
