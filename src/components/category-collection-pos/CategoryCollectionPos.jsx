            ...
            {props.loading ? (
                ...
                <>
                    <Row justify="space-between">
                        {dataCategory &&
                        Array.isArray(dataCategory.best_match) &&
                        dataCategory.best_match.length > 0 ? (
                            <TablePosition
                                ...
                                title={
                                    <>
                                        ...
                                        {!token && (
                                            ...
                                            >
                                                Ranking of <strong>{nameApp}</strong> in best match categories of the
                                                Shopify App Store
                                            </span>
                                        )}
                                    </>
                                ...
                                title={
                                    <>
                                        ...
                                        {!token && (
                                            ...
                                            >
                                                Ranking of <strong>{nameApp}</strong> in the most popular categories of
                                ...
                                title={
                                    <>
                                        ...
                                        {!token && (
                                            ...
                                            >
                                                Ranking of <strong>{nameApp}</strong> in best match collections of the
                                                Shopify App Store.
                                            </span>
                                        )}
                                    </>
                                ...
                                title={
                                    <>
                                        ...
                                        {!token && (
                                            ...
                                            >
                                                Ranking of <strong>{nameApp}</strong> in the most popular collections of
                                                the Shopify App Store.
                                            </span>
                                        )}
                                    </>
