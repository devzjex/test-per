                        ...
                        <div className={appDetail.built_for_shopify ? 'item-develop mt-10' : 'item-develop'}>
                            <div className="image-item">
                                <div className="image-wrapper">
                                    {appDetail.app_icon ? (
                                        <Image src={appDetail.app_icon} alt="App Icon" width={90} height={90} />
                                    ) : (
                                        <Image src="/image/no-image.webp" alt="No icon app" width={90} height={90} />
                                    )}
                                </div>
                            </div>
                            <div className="content">
                                ...
                                <Row className="review">
                                    ...
                                    <span>
                                        {appDetail
                                            ? `${appDetail.star} (${
                                                  appDetail.review_count !== undefined
                                                      ? appDetail.review_count
                                                      : appDetail.review
                                              })`
                                            : ''}
                                    </span>
