...
export default function ModalKeywordFrequency(props) {
    ...
    const handleCellClick = (value, record, column) => {
        ...
        <div>
          ...
          <div><h3>Description</h3><p>${content.description}</p></div>
      ...
      `;
        ...
        const contentMapping = {
            ...
            description: (content) => `<div><h3>Description</h3><p>${content}</p></div>`,
            ...
            integrations: (content) =>
                `<div><h3>Integrations</h3><p>${content.join(' ').replace(/\s+/g, ', ')}</p></div>`,
            features: (content) =>
    ...
    const columnsKeywordFrequency = [
                                  ...
                                  <MyLink href={`${item.app_id}`}>
                                      <Avatar
                                          style={{
                                              ...
                                              margin: '0 1px',
                                              border:
                                                  item.app_id === props.appId ? '2px solid #ff9900' : '1px solid white',
                                              boxShadow:
                                                  item.app_id === props.appId ? '0 0 10px rgba(255, 0, 0, 1)' : 'none',
                                          }}
                                          src={item.app_icon}
                                      />
                                  </MyLink>
        ...
        {
            title: <Tooltip title="Total Count">T.Count</Tooltip>,
            dataIndex: 'count',
            render: (count, record) => (
        ...
        {
            title: <Tooltip title="App Detail">A.Detail</Tooltip>,
            dataIndex: 'details',
        ...
        {
            title: <Tooltip title="App Name">A.Name</Tooltip>,
            dataIndex: 'details',
            render: (details, record) => (
                <span
                    onClick={() => handleCellClick(details?.app_name, record, 'name')}
                    className="value-keyword-frequency"
                >
                    {details?.app_name || ''}
                </span>
        ...
        },
        {
            ...
            render: (details, record) => (
                <span
                    onClick={() => handleCellClick(details?.description, record, 'description')}
                    className="value-keyword-frequency"
                >
                    {details?.description || ''}
                </span>
        ...
        },
        {
            ...
            render: (details, record) => (
                <span
                    onClick={() => handleCellClick(details?.tagline, record, 'tagline')}
                    className="value-keyword-frequency"
                >
                    {details?.tagline || ''}
                </span>
