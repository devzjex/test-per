...
export default function CustomerLifecycle(props) {
    ...
    useEffect(() => {
        if (props.value) {
            ...
            const dataInstall =
                props.value && props.value.data && props.value.data.install_by_date
                    ? props.value.data.install_by_date
                    : [];
            const dataUninstall =
                props.value && props.value.data && props.value.data.uninstall_by_date
                    ? props.value.data.uninstall_by_date
                    : [];
