        ...
        if (chartData.length > 0) {
            ...
            if (reviewChange > 0) {
                return {
                    message: (
                        <>
                            {<strong>{nameApp}</strong>} has gained <strong>{reviewChange}</strong> new reviews in the
                            past <strong>{diffDays}</strong> days.
                        </>
                    ),
                };
        ...
        if (chartData.length > 0) {
            ...
            if (firstRating !== lastRating) {
                ...
                return {
                    message: (
                        <>
                            {<strong>{nameApp}</strong>} rating has no change in the past <strong>{diffDays}</strong>{' '}
                            days.
                        </>
                    ),
                };
