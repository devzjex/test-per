    ...
    return (
        ...
        >
            <div style={{ marginBottom: '1rem' }}>
                Installation time : <strong>{props.dateInstall}</strong> - Checking time:{' '}
                <strong>{props.dateCheck}</strong> <br /> Retention and merchant type is counted base on the last
                session of merchants.
            </div>
