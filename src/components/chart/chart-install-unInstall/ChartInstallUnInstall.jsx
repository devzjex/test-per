    ...
    const createData = (data, hiddenDataset, type) => {
        ...
        labels.forEach((label) => {
            ...
            if (filteredData.length > 0) {
                datasets['Installs'].push(
                    filteredData.reduce((sum, val) => sum + (val.installed_shop_count || 0), 0) || null,
                );
                ...
                datasets['Closed'].push(
                    filteredData.reduce((sum, val) => sum + (val.deactivated_shop_count || 0), 0) || null,
                );
                datasets['Declined'].push(
                    filteredData.reduce((sum, val) => sum + (val.declined_shop_count || 0), 0) || null,
                );
                    ...
                    <ResponsiveContainer width="100%" height={400}>
                        <ComposedChart data={dataColumnUnInstall}>
                            ...
                            <Bar
                                ...
                                fill="#482779"
                                stackId="uc"
                                hide={hiddenDatasetUninstall.Closed}
                                barSize={30}
                            />
                            <Bar
                                dataKey="Uninstalls"
                            ...
                            <Bar
                                dataKey="Declined"
                                fill="#1E90FF"
                                hide={hiddenDatasetUninstall.Declined}
                                barSize={30}
                            />
                            <Bar
