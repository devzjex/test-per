...
export default function Earnings({ props }) {
                    ...
                    <>
                        {selectedValue === 'D' ? (
                            ...
                            <span>
                                $
                                {dataSelectedTotalEarningBefore
                                    ? Math.round(dataSelectedTotalEarningBefore).toLocaleString()
                                    : ''}{' '}
                            </span>
                        )}
                    </>
                    ...
                    <>
                        {selectedValue === 'D' ? (
                            <span>
                                ...
                                {dataEarningByDate
                                    ? Math.round(
                                          safeDivide(props.value.total_earning, dataEarningByDate.length),
                                      ).toLocaleString()
                                    : ''}
                            </span>
                        ) : (
                            <span>
                                ...
                                {dataEarningByDateSelected
                                    ? Math.round(
                                          safeDivide(props.value.total_earning, dataEarningByDateSelected.length),
                                      ).toLocaleString()
                                    : ''}
                            </span>
                        )}
    ...
    return (
        <div className="earnings">
            ...
            <div
                className={`${(dataEarningByDateSelected || dataEarningByDate) && !loading ? 'chart' : 'chart-loading'}`}
            >
