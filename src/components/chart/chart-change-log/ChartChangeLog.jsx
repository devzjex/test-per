        ...
        return (
            <article className="change-log-text">
                <p className="change-log-desc">
                    Our change log tracking for <strong>{nameApp}</strong> has recorded all the changes in its app
                    listing on the Shopify App Store.
                </p>
                {isExpanded && (
                    <>
                        <p className="change-log-desc">
                            In the past <strong>{totalMonths}</strong> months, <strong>{nameApp}</strong> has the total
                            of <strong>{totalChanges}</strong> changes, mostly in{' '}
                            <strong>
                        ...
                        <p className="change-log-desc">
                            <strong>{nameApp}</strong> has modified their pricing plan{' '}
                            <strong>{pricingPlanChanges}</strong> times with the latest change made on{' '}
                            <strong>{latestPricingPlanChangeDate}</strong>.
                        </p>
                        <p className="change-log-desc">
