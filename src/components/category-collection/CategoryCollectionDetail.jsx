...
export default function CategoryCollectionDetail({ dataInitial }) {
    ...
    const columns = [
        ...
        },
        {
            ...
            key: 'highlights',
            render: (highlights) => (
                <ul>{highlights && highlights.map((item, index) => <li key={index}>{item}</li>)}</ul>
            ),
            width: 170,
        },
        {
                ...
                {data ? (
                    <div className="detail-categories-body container">
                        <div className="container-title-body">
                            <div className="wrapper-title">
                                ...
                                <div className="information-cate">
                                    <div className="title-apps">
                                        <span>{total}</span>&nbsp;apps - Average price:&nbsp;<span>${avgPrice}</span>
                                        /month
                                    </div>
                                    <MyLink
                            ...
                            <div className="sort">
                                {renderSelect(optionsSortBy, 'Sort By', sort_by, (value) =>
                                    handleChangeSort('sortBy', value),
                                )}
                                {renderSelect(optionsSortType, 'Sort Type', sortType, (value) =>
                                ...
                                {renderSelect(optionsLanguage, 'Location', language, (value) =>
                                    handleChangeSort('language', value),
                                )}
                            </div>
                        </div>
