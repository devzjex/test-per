                                    ...
                                    <Input
                                        ...
                                        suffix={
                                            showPassword.newPass ? (
                                                <EyeOutlined
                                                    onClick={() => setShowPassword({ ...showPassword, newPass: false })}
                                                />
                                            ) : (
                                                <EyeInvisibleOutlined
                                                    onClick={() => setShowPassword({ ...showPassword, newPass: true })}
                                                />
                                            )
                                        }
                                    ...
                                    <Input
                                        ...
                                        suffix={
                                            showPassword.confirmPass ? (
                                                <EyeOutlined
                                                    onClick={() =>
                                                        setShowPassword({ ...showPassword, confirmPass: false })
                                                    }
                                                />
                                            ) : (
                                                <EyeInvisibleOutlined
                                                    onClick={() =>
                                                        setShowPassword({ ...showPassword, confirmPass: true })
                                                    }
                                                />
                                            )
                                        }
