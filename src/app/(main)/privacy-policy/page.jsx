        ...
        <div className="item-page" itemScope itemType="http://schema.org/Article">
          ...
          <div className="articleBody" itemProp="articleBody">
            <p>
              ...
              <br />
              We do not collect information from individuals under the age of 13. If you are under the age of 13, we ask
              that you do not provide any personal information through this site. If we have specific knowledge that an
              individual under the age of 13 has submitted personally identifiable information to this site, we will
              remove such information without any notification.
              <br />
            ...
            <p>
              If you would like to ask about, make a request relating to, or complain about how we process your personal
            ...
            <p>
              ...
              Analytics data as is without editing or attaching them to any sources that render the data identifiable to
              anyone, other than the corresponding authorized user of the Google Analytics account themselves.
              <br />
            ...
            <p>
              If you use a credit card to purchase an account via this site, your name as it appears on the credit card,
              the credit card number, expiration date, and billing address will be encrypted as it passes over the
              Internet. Omegatheme does not record or keep your credit card information for online credit-card
              transactions; rather such information is simply passed through to our contracted payment processing vendor
              (PayPal, MoneyBookers, etc.). Omegatheme may access such information through the payment processing
              company, but does not do so except to process refunds or adjustments and to the extent necessary in the
              event of nonpayment or disputed payments, or as may be necessary for Omegatheme' compliance, in
            ...
            <p>
              ...
              of a cookie is in no way linked to any personally identifiable information while on our Site. Once you
              close your browser, the cookie simply terminates. For instance, by setting a cookie on our Site, you would
              not have to log in a password more than once, thereby saving time while on our Site. You may still use our
              Site if you reject the cookie. The only drawback to this is that you will be limited in some areas of our
              Site. For example, you will not be able to use certain features of our forum or other parts of the Site
              that offer customized settings.
            </p>
            <h3>Log Files</h3>
            <p>
              We (Omegatheme and/or our contracted web analytics provider(s)) do keep track of the domains from which
              you access our Site and Services on the World Wide Web, and may log IP addresses or other identifiers for
              statistical purposes. We do this to gather broad demographic information for aggregate use to identify and
              analyze trends and the results of our marketing efforts, to help diagnose problems with our servers and to
              administer the Site and Services, and analyze users' movements. We may periodically share aggregated
              demographic information with our business partners. IP addresses and other identifiers are not linked to
              personally identifiable information.
            </p>
            <h3>Links to other websites</h3>
            <p>
              This Site contains links to other sites. Please be aware that we, Omegatheme, are not responsible for the
              privacy practices of such other sites. We encourage you to be aware when you leave our Site and to read
              the privacy statements of each website that collects personally identifiable information. This privacy
            ...
            <p>
              ...
              search warrant or other lawful request for information we receive, or to otherwise protect our rights. In
              addition, we share your information with service providers who provide IT and system administration
              services.
              <br />
              ...
              other related services (e.g., to confirm your identity, to contact you about issues with the tool). Before
              we share your personal data with any third party for their own marketing purposes we will get your express
              consent.
              <br />
              ...
              at any time, but be noted that this opt-out action does not apply to personal data provided as a result of
              other transactions such as complete a payment, etc.
            </p>
            ...
            <p>
              ...
              <br />
              The Site is regularly tested for security breaches to ensure that all information collected is secure from
              unauthorized viewing. Finally, we do not and will not “sell” your personal information.
            </p>
