...
import { CloseOutlined, HomeOutlined, LoadingOutlined, RightOutlined } from '@ant-design/icons';
                                                            ...
                                                            {app_host?.detail.built_for_shopify === true && (
                                                                <div className="icon-bfs">
                                                                    <Tooltip
                                                                        title={
                                                                            app_host?.detail &&
                                                                            app_host?.detail.rank_bfs > 0
                                                                                ? app_host?.detail.rank_bfs
                                                                                : ''
                                                                        }
                                                                    >
                                                                        <Image
                                                        ...
                                                        >
                                                            ...
                                                            {app?.detail.built_for_shopify === true && (
                                                                <div className="icon-bfs">
                                                                    <Tooltip
                                                                        title={
                                                                            app?.detail && app?.detail.rank_bfs > 0
                                                                                ? app?.detail.rank_bfs
                                                                                : ''
                                                                        }
                                                                    >
