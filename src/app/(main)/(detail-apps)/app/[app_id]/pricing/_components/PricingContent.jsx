...
export default function PricingContent({ initialDataAppInfo }) {
    ...
    const competitorPricingRender = () => {
        ...
        const maxAppsRaw = [9, 6, 3].find((n) => filteredDataApps.length >= n) || filteredDataApps.length;
        const maxApps = maxAppsRaw % 2 === 0 ? maxAppsRaw : maxAppsRaw - 1 > 0 ? maxAppsRaw - 1 : 0;
                        ...
                        return (
                            <div key={item.app_id} className="content-app">
                                    ...
                                    <div className="app-icon-pricing">
                                        ...
                                        <div className="info">
                                            ...
                                            <span className="price-title">
                                                {item.app_pricing.pricing_min !== null
                                                    ? item.app_pricing.pricing_min
                                ...
                                <div className="trial">
                                    <div className="free-trial">
                                        ...
                                        {item.app_pricing.free ? (
                                            ...
                                            <div className="item-pricing">
                                                <Image
                                                    src="/image/check-icon-error.png"
                                                    width={40}
                                                    height={40}
                                                    alt="icon-check"
                                                />
                                ...
                                <div className="action">
                                    <MyLink
                                        href={compareUrl}
                                        className="button-compare-app btn-compare-detail"
                                        target="__blank"
                                    >
                                        <SwapOutlined />
                                        Compare
                                    ...
                                    <MyLink
                                        ...
                                        className="button-add-app btn-compare-detail"
                                        target="__blank"
                                    >
                                        View Details
                                    </MyLink>
                                        ...
                                        {isChecked ? (
                                            dataAppInfo.some((plan) => plan.yearly !== null) ? (
                                                ...
                                                <Empty
                                                    ...
                                                    description="Yearly plan not available"
                                                />
                                            )
                                            ...
                                            <Empty
                                                image={Empty.PRESENTED_IMAGE_DEFAULT}
                                                description="Monthly plan not available"
                                            />
                                        )}
                                    </div>
                                </>
