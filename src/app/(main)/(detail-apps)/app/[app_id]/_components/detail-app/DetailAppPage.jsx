...
export default function DetailAppPage({ app_id, initialDataAppInfo, initialPanes, initialDataCateCollections, token }) {
    ...
    const getAppInfoLogged = async (id, fromDate, toDate, compare_app_id) => {
        ...
        const [
            ...
            DetailAppApiService.getSubscriptionByPlan(appId, fromDate, toDate),
        ]);
        const resultChart = {
            ...
            subscription_by_pricing: dataSubscriptionByPlan.data,
        ...
        if (dataEarning && dataEarning.code === 0) {
            ...
            if (selectedValue === 'Q') {
                ...
                for (let i = 0; i < 8; i++) {
                    ...
                    const totalUnfrozenCharge = earningInQuarter.reduce(
                        (total, item) => total + item.unfrozen_charge,
                        0,
                    );
        ...
        try {
            switch (selected) {
                ...
                case 'M':
                    ...
                    const dataFor12Months = await getDataEarningAndMerchantApp(
                        id,
                        fromDateYearAgo,
                        toDateCurrentMonth,
                        selected,
                ...
                case 'Q':
                    ...
                    const dataForQuarter = await getDataEarningAndMerchantApp(
                        id,
                        fromDateQuarter,
                        toDateQuarter,
                        selected,
                ...
                <div className={isMobile ? 'p-20' : 'container'}>
                            ...
                            <div className="button-add">
                                {activeState && infoApp && activeState == 1 && (
                                    <div className="left">
                                        ...
                                        >
                                            <Image
                                                src={'/image/ai-keyword.png'}
                                                width={30}
                                                height={28}
                                                alt="icon-keyword-frequency"
                                            />
                                        </Tooltip>
                                        <Tooltip
                                        ...
                                        >
                                            <Image
                                                src={'/image/keyword-frequency.png'}
                                                width={20}
                                                height={19}
                                                alt="icon-keyword-frequency"
                                            />
                    ...
                    <div className="chart-weekly-category-keyword">
                        <ChartCategory
                            ...
                            dataPopular={
                                dataDetailApp?.dataCategoryPos?.popular
                                    ? createData(dataDetailApp.dataCategoryPos.popular)
                                    : null
                            }
                            ...
                            dataWeeklyChangePopular={
                                dataKeywordsChange &&
                                createData(
                                    dataKeywordsChange.popular.popular
                                        ? dataKeywordsChange.popular.popular
                                        : dataKeywordsChange.popular,
                                )
                            }
                            token={token}
                        />
