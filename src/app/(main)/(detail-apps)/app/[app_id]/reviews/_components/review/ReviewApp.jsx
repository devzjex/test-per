...
export default function ReviewApp({ initialDataReviews }) {
    ...
    const handleChangeSort = useCallback(
        async (value) => {
            ...
            const newIsActive = sortValue === 1 ? true : null;
            const newIsDeleted = sortValue === 2 ? true : null;
            const newIsArchived = sortValue === 3 ? true : null;

            setIsActive(newIsActive);
            setIsDeleted(newIsDeleted);
            setIsArchived(newIsArchived);

            const typeReview = sortValue === 2 ? 'deleted' : sortValue === 3 ? 'archived' : 'active';
            try {
        ...
        [isActive, isDeleted, isArchived, total],
    );
                            ...
                            {isSize ? (
                                ...
                                <div className="review_app_flex_box_filter">
                                    <div className="filter-header-desktop">
                                        <div className="filter-status">
                                            <Title level={4}>
                                                {filters.length > 0 ? renderFilterStatus() : 'Filter reviews by'}
                                            </Title>
                                            {filters.length > 0 && (
                                                <>
                                                    <Button
