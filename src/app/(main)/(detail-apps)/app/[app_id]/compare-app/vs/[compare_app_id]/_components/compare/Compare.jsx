...
export default function Compare({ compareAppData, token }) {
    ...
    const handleScroll = (e) => {
        if (!e.target.classList.contains('ant-table-content')) return;
    ...
    useEffect(() => {
        const container = document.querySelector('.container-compare_app');
        if (container) {
    ...
    const filteredRecommendedAppCompare = recommendedAppCompare.filter((app) => !excludedAppIds.includes(app.app_id));
    const combinedFilteredApps = [...filteredRecommendedAppCompare, ...filteredRecommendedApps];
                ...
                <>
                    ...
                    <div className="app">
                        ...
                        <div className="title-app">
                            <MyLink
                                href={`${BASE_URL}app/${value.id}`}
                                target={`_blank${value.id}`}
                                className="app-name"
                            >
