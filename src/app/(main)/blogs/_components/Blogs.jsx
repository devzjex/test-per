...
import './Blogs.scss';
import { Pagination, Row, Col, Typography, Card, Tag, Rate } from 'antd';
...
const ListBlogs = ({ initialDataBlogs, page, per_page }) => {
    ...
    const [allTags, setAllTags] = useState(initialDataBlogs.allTags || []);
    const [allBlogs, setAllBlogs] = useState(initialDataBlogs.allBlogs || []);

    useEffect(() => {
        setBlogs(initialDataBlogs.data);
        setAllBlogs(initialDataBlogs.allBlogs || []);
        setTotal(initialDataBlogs.total);
        setAllTags(initialDataBlogs.allTags || []);
    }, [page, per_page, initialDataBlogs]);
            ...
            <div className="container-blogs">
                ...
                <Row gutter={[30, 30]}>
                    <Col xs={24} sm={24} md={16} lg={18} className="blog-section">
                        ...
                        {selectedTags.length === 0 && total > 0 && blogs.length > 0 && (
