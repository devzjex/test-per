                                ...
                                <div className="info-store">
                                    {domainStore && (
                                        <>
                                            ...
                                            <MyLink
                                                href={`https://${domainStore}`}
                                                target="__blank"
                                                rel="nofollow noopener noreferrer"
                                            >
                                                <Typography.Text className="content link-store">
                                                    {domainStore}
                                                </Typography.Text>
                                            </MyLink>
                    ...
                    {isLetsmetrix ? (
                        <Card title={<Title level={4}>Apps</Title>} bordered className="info-store-card">
                            <List
                                ...
                                dataSource={storeData?.apps.slice(
                                    0,
                                    expandedSections.apps ? storeData?.apps.length : MAX_ITEMS,
                                )}
                                renderItem={(app) => {
                                                    ...
                                                    app?.built_for_shopify && (
                                                        <Tooltip title="Built for shopify">
                                                            <div className="built4-shopify">
                                                                ...
                                                                />
                                                                <strong>
                                                                    {app?.rank_bfs ? <>{app?.rank_bfs}</> : null}
                                                                </strong>
                                                            </div>
                                                        </Tooltip>
                                                    )
                                                ...
                                                <List.Item.Meta
                                                    ...
                                                    description={
                                                        <div className="install-rating">
                                                            <span className="rate">
                                                                <StarFilled />{' '}
                                                                <span className="count-rate">{app.average_rating}</span>
                                                            </span>
                                                            {app.installed_at ? (
                                                                <span>{`Installed At: ${formatDate(app.installed_at)}`}</span>
                                                            ) : (
                                                                ''
                                                            )}
                        ...
                        <Card title={<Title level={4}>Categories</Title>} bordered className="info-store-card">
                            <Row>
                                {storeData?.categories
                                    .slice(
                                        0,
                                        expandedSections.categories ? storeData?.categories.length : MAX_ITEMS_CATE_COL,
                                    )
                                    .map((category, index) => {
                                                        ...
                                                        <div>
                                                            ...
                                                            <Paragraph type="secondary">
                                                                {event.billing_interval === 'EVERY_30_DAYS' ? (
                                                                    <>
                                                                        ${event.charge.amount.amount}{' '}
                                                                        {event.charge.amount.currencyCode} billed every
                                                                        30 days, starting immediately.
                                                                    </>
                                                                ) : (
                                                                    <>
                                                                        ${event.charge.amount.amount}{' '}
                                                                        {event.charge.amount.currencyCode}
                                                                    </>
                                                                )}
                                                            </Paragraph>
                                                        </div>
                        ...
                        {selectedApp ? (
                            <div className="content-open-detail">
                                {selectedApp.platform && (
                                    <Paragraph type="secondary">Platform: {selectedApp.platform}</Paragraph>
                                )}
                                ...
                                {selectedApp.categories && (
                                    <>
                                        ...
                                        {selectedApp.categories
                                            .slice(
                                                0,
                                                expandedSections.categories_modal ? selectedApp.categories.length : 20,
                                            )
                                            .map((category, index) => (
                                                <Tag className="tag-cate" key={index}>
                                                    {category}
                                        ...
                                        {selectedApp.categories.length > 20 && (
                                            <div style={{ textAlign: 'center' }}>
                                                <Button
                                                    type="text"
                                                    onClick={() => toggleExpand('categories_modal')}
                                                    className="show-item"
                                                >
