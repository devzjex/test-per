    ...
    const searchStoreList = useCallback(
        async (keyword = '', currentPage = 1, appId = 'all', category = '', source = '') => {
            try {
                ...
                const result = await StoreApiService.searchStores(
                    keyword,
                    currentPage,
                    20,
                    appIdToUse,
                                                ...
                                                <List.Item>
                                                    <div className="store-item">
                                                        <div className="information-store">
                                                            <strong>Name: </strong>
                                                            <span>
                                                                {isLetsmetrix ? store.name : store.merchant_name}
                                                            </span>
                                                            <strong> - Domain: </strong>
                                                            <span className="domain">
                                                                {isLetsmetrix
                                                                    ? store.domain
                                                                    : store.platform_domain || store.id}
                                                            </span>
                                                        </div>
                                                                ...
                                                                <>
                                                                    {store.apps.slice(0, 4).map((app) => (
                                                                        <Tooltip
                                                                            ...
                                                                            title={
                                                                                isLetsmetrix ? app.app_name : app.name
                                                                            }
                                                                        >
                                                                            <Avatar
                                                                                src={
                                                                    ...
                                                                    {store.apps.length > 4 && (
                                                                        <Tooltip
                                                                            title={`${store.apps.length - 4} more apps`}
                                                                        >
                                                                            <Avatar
                                                                                size={30}
                                                                                className="more-apps-avatar"
                                                                            >
                                                                                +{store.apps.length - 4}
                                                                            </Avatar>
                                                                        </Tooltip>
                                                            ...
                                                            {store.apps_other && store.apps_other.length > 0 ? (
                                                                <>
                                                                    ...
                                                                    {store.apps_other.length > 4 && (
                                                                        <Tooltip
                                                                            title={`${store.apps_other.length - 4} more apps`}
                                                                        >
                                                                            <Avatar
                                                                                size={30}
                                                                                className="more-apps-avatar"
